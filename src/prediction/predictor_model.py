...
class Forecaster:
    """A wrapper class for the PatchTST Forecaster.

    This class provides a consistent interface that can be used with other
    Forecaster models.
    """

    model_name = "PatchTST Forecaster"
    ...
    def __init__(
        ...
        """Construct a new PatchTST Forecaster
    ...
    def fit(
        ...
        A separate PatchTST model is fit to each series that is contained
        in the data.
